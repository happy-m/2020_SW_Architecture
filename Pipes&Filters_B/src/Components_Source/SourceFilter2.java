...
public class SourceFilter2 extends GeneralFilter {
	// Courses.txt 저장할 인수
	private String filePath;
	private int outPlace;

	public SourceFilter2(String inputFilePath, int in, int out) { // course정보 읽음
		super(in, out);
		this.outPlace = out - 1;
	...
	public void specificComputationForFilter() throws IOException {
		...
		try {
			...
			for (;;) {
				...
				// 1번지에 있는 정보, 즉 Courses.txt 읽어서 MiddleFilter로 전달
